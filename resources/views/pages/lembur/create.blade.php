...
@section('content')
    <div class="bg-slate-800 p-6 rounded-2xl shadow-lg">
        <h2 class="text-xl font-semibold mb-6">Tambah Data Lembur</h2>
        ...
        <form action="{{ route('lembur.store') }}" method="POST" class="space-y-4">
            ...
            <div class="flex gap-4">
                <div class="w-1/2">
                    ...
                    <input type="number" name="bulan" min="1" max="12" value="{{ old('bulan') }}"
            ...
            <div>
                ...
                <input type="number" name="jumlah_jam" min="0" value="{{ old('jumlah_jam') }}"
                    class="w-full rounded-lg p-2 bg-slate-700 text-white">
            ...
            <div>
                ...
                <input type="number" name="rate_per_jam" min="0" value="{{ old('rate_per_jam') }}"
                    class="w-full rounded-lg p-2 bg-slate-700 text-white">
